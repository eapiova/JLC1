...
The rules of $\eseq$ are collected in Figure~\ref{fig:rules}.
...
We conclude the section by showing the \agda{} code of the Subformula Property, i.e.\ of Corollary~\ref{cor:subformula}. The listing is generated from the source and displays, besides the signature, the four cases that carry the content: the base case, the impossible Cut case, and the two flavours of modal cases.
