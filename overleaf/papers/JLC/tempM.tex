...
\begin{abstract}
    ...
    This paper is an extended version of~\cite{Borsetto2025:S42Investigations}, presented at ICTCS 2025. With respect to that contribution, the present version adds the formalisation of the Cut-Elimination Theorem and of its corollaries, the finite semilattice semantics together with its soundness proof, and the study of the relation with the Hilbert-style axiomatisation.
\end{abstract}
