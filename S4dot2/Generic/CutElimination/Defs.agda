...
-- S4dot2/CutElimination/Defs.agda lines 25-183; only this header differs
-- (module parameterized over TA; Syntax/System opens flipped to the Generic
-- layer; ListExt opened directly since Generic.Syntax does not re-export it).

open import S4dot2.TokenAlgebra.Interface

module S4dot2.Generic.CutElimination.Defs (TA : TokenAlgebra) where
